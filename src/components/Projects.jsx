...
import { BsChevronDoubleDown, BsCodeSlash, BsGithub } from 'react-icons/bs';
    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col justify-center md:h-full px-4">
        ...
        <div className="flex justify-center">
          <div className={`grid gap-14 pt-5 px-5 sm:px-8 grid-cols-1 sm:grid-cols-2 sm:gap-12 md:grid-cols-3 max-w-screen-lg ${mapProjects.length < 4 ? 'md:pt-36 sm:gap-10 md:grid-cols-2 md:max-w-3xl' : 'pt-7' }`}>
          { mapProjects.map(({ id, name, src, href, repository, style }) => (
            <div key={id} className={`shadow-md rounded-lg w-full ${style} duration-200 hover:scale-105`}>
